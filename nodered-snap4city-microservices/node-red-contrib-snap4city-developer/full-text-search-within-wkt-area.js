...
module.exports = function (RED) {
    ...
    function FullTextSearchWithinWktArea(config) {
        ...
        node.on('input', function (msg) {
            ...
            xmlHttp.open("GET", encodeURI(uri + "?search=" + search + "&selection=wkt:" + wktarea + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
