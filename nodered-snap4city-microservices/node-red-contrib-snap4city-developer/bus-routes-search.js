...
module.exports = function (RED) {
    ...
    function BusRoutesSearch(config) {
        ...
        node.on('input', function (msg) {
            ...
            xmlHttp.open("GET", encodeURI(uri + "?selection=" + selection + "&agency=" + agency + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + "&geometry=" + geometry + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
