...
module.exports = function (RED) {
    ...
    function NotificatorHistoryEvents(config) {
        ...
        node.on('input', function (msg) {
            ...
            xmlHttp.open("GET", encodeURI(uri + "&startDate=" + startdate + "&endDate=" + enddate + "&dashboardTitle=" + dashboard + "&widgetTitle=" + widget + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
