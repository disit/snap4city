...
module.exports = function (RED) {
            ...
            switch (response.msgType) {
                case "AddEditMetric":
                    if (response.result === "Ok") {
                        ...
                        console.log(node.getNow() + " - WebSocket server could not add/edit metric type for gauge-chart node " + node.name + ": " + JSON.stringify(response));
                    }
                    break;
    ...
    function DashBoardTitleService(n) {
        RED.nodes.createNode(this, n);
        this.dashboardtitle = n.dashboardtitle;
    }
    RED.nodes.registerType("dashboard-title-service", DashBoardTitleService);
};