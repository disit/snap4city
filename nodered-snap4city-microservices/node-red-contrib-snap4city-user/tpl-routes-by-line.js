...
module.exports = function (RED) {
    ...
    function TplRoutesByLine(config) {
        ...
        node.on('input', function (msg) {
            var uri = "http://servicemap.km4city.org/WebAppGrafo/api/v1/tpl/bus-routes/";
            ...
            xmlHttp.open("GET", encodeURI(uri + "?agency=" + agency + "&line=" + line + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
