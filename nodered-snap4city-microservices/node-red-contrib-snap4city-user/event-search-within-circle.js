...
module.exports = function (RED) {
    ...
    function EventSearchWithinCircle(config) {
        ...
        node.on('input', function (msg) {
            ...
            xmlHttp.open("GET", encodeURI(uri + "?range=" + range + "&selection=" + latitude + ";" + longitude + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
