...
module.exports = function (RED) {
    ...
    function AddressPoiSearchByTextNearMarker(config) {
        ...
        node.on('input', function (msg) {
            ...
            xmlHttp.open("GET", encodeURI(uri + "?search=" + search + "&position=" + latitude + ";" + longitude + "&searchMode=ANDOR" + "&excludePOI=false" + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
