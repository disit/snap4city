...
module.exports = function (RED) {
    ...
    function RecommendationsWithinCircle(config) {
        ...
        node.on('input', function (msg) {
            ...
            xmlHttp.open("GET", encodeURI(uri + "?action=recommend&mode=manual&aroundme=true&version=4.4.0&profile=" + profile + "&latitude=" + latitude + "&longitude=" + longitude + "&distance=" + maxDists + "&lang=" + language + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
