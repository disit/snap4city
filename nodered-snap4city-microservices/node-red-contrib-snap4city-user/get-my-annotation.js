...
module.exports = function (RED) {
    ...
    function GetMyAnnotation(config) {
        ...
        node.on('input', function (msg) {
            var uri = "http://192.168.0.10:8080/datamanager/api/v1/apps/" + RED.settings.APPID + "/data";
            ...
            if (checkConsent) {
                ...
                xmlHttp.open("GET", encodeURI(uri + "?sourceRequest=iotapp" + (typeof motivation != "undefined" && motivation != "" ? "&motivation=" + motivation : "") + (typeof startdate != "undefined" && startdate != "" ? "&from=" + startdate : "") + (typeof enddate != "undefined" && enddate != "" ? "&to=" + enddate : "") + (typeof last != "undefined" && last != "" ? "&last=" + last : "") + "&accessToken=" + accessToken), false);
