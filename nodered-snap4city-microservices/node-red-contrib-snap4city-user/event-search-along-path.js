...
module.exports = function (RED) {
    ...
    function EventSearchAlongPath(config) {
        ...
        node.on('input', function (msg) {
            ...
            xmlHttp.open("GET", encodeURI(uri + "?range=" + range + "&selection=wkt:" + path + "&maxResults=" + maxResults + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
