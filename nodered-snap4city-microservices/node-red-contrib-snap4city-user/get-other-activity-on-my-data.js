...
module.exports = function (RED) {
    ...
    function GetOtherActivityOnMyData(config) {
        ...
        node.on('input', function (msg) {
            var uri = "http://192.168.0.10:8080/datamanager/api/v1/apps/" + RED.settings.APPID + "/activity";
            ...
            var xmlHttp = new XMLHttpRequest();
            if (checkConsent) {
                console.log(encodeURI(uri + "?sourceRequest=iotapp&delegated=true" + "&accessToken=" + accessToken));
                xmlHttp.open("GET", encodeURI(uri + "?sourceRequest=iotapp&delegated=true" + "&accessToken=" + accessToken), false);
