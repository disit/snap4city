...
module.exports = function (RED) {
    ...
    function GeometrySearchNearMarker(config) {
        ...
        node.on('input', function (msg) {
            ...
            xmlHttp.open("GET", encodeURI(uri + "?position=" + latitude + ";" + longitude + "&intersectGeom=true" + "&format=json" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"), false); // false for synchronous request
            xmlHttp.send(null);
