    ...
    function loadEditor() {
        ...
        menuOptions.push({
            ...
            options: [{
                ...
                /* s4c init*/
                {
                    id: "menu-item-import-cloud",
                    label: RED._("Import S4C"),
                    onselect: "core:show-import-cloud-dialog"
                },
                /* s4c end */
                /* microservice init*/
                {
                    id: "menu-item-import-microservice",
                    label: RED._("Import External MicroService"),
                    onselect: "core:show-import-microservice"
                },
                /* microservices end */
                /* damicroservices init*/
                {
                    id: "menu-item-import-damicroservice",
                    label: RED._("Import Data Analytic MicroService"),
                    onselect: "core:show-import-damicroservice"
                }
                /* damicroservices end */
            ]
        });
        menuOptions.push({
            ...
            options: [{
                ...
                /* s4c init */
                {
                    id: "menu-item-export-cloud",
                    label: RED._("Save S4C"),
                    disabled: false,
                    onselect: "core:show-export-cloud-dialog"
                }
                /* s4c end */
        ...
        menuOptions.push({
            ...
            label: RED._("menu.label.userSettings"),
