...
public interface ICredentialsService {
	...
	String getAccessToken(Locale lang) throws CredentialsException;

	void checkAssistanceEnabled(Locale lang) throws NoSuchMessageException, CredentialsException, IOException;
}