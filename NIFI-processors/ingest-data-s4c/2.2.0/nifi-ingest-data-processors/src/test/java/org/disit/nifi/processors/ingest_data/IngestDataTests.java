...
public class IngestDataTests {
	...
	//@Test
	public void testIngestData() throws IOException {
		System.out.println( "#### Test Ingest Data ####" );
		...
		System.out.println( "Entry date: " + Instant.ofEpochMilli( successFF.getEntryDate() ).toString() );
	...
	public void testAttributesExtraction() throws IOException {
		...
		testRunner.setProperty( IngestData.EXTRACT_FIELDS_AS_ATTRIBUTES , "data/latitude/value" );
