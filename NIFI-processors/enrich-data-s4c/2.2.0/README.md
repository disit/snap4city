...
Apache NiFi target version: `2.2.0`.  
...
```
distribution/target/nifi-enrich-data-bundle-2.2.0.tar
```

The content of the archive will be:

```
nifi-enrich-data-bundle-2.2.0
├── nifi
│   ├── conf
│   │   └── enrich-data.conf
│   └── extensions
│       ├── nifi-enrich-data-nar-2.2.0.nar
│       ├── nifi-enrichment-source-client-service-api-nar-2.2.0.nar
│       ├── nifi-oauth-token-provider-service-nar-2.2.0.nar
│       ├── nifi-ownership-client-service-nar-2.2.0.nar
│       ├── nifi-resource-locator-services-nar-2.2.0.nar
│       └── nifi-servicemap-client-services-nar-2.2.0.nar
└── test-tools
    └── test-server
            ├── bin
            │   └── test_server.sh
...
By default `<NiFi Home>/nar_extensions`.
...
3. Enrich the flow file content with the retrieved enrichment data.
4. Produce the output flow file(s) according to the configured output format.
