...
public class Cluster {
    ...
    // Daniele
    private ArrayList<Integer> trajectoriesIdList;
    ...
    /**
     * set m_nTrajectories --the number of trajectories belonging to this
     * cluster
     *
     * @param density
     */
    ...
    // Daniele
    /**
     * set trajectoriesIdList - the list of trajectories ids cluster
     *
     * @param trajectoriesIdList
     */
    public void setTrajectoriesIdList(ArrayList<Integer> trajectoriesIdList) {
        this.trajectoriesIdList = trajectoriesIdList;
    }

    // Daniele
    /**
     * get trajectoriesIdList - the list of trajectories ids cluster
     *
     *
     */
    public ArrayList<Integer> getTrajectoriesIdList() {
        return this.trajectoriesIdList;
    }
}
