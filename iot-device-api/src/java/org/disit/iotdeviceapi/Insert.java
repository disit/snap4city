...
public class Insert extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            xlogger = new XLogger(Insert.class.getName(),cfgParser.getLoggingFolder());
            ...
            for(int n = 0; n < dataNodes.getLength(); n++) {
                ...
                xlogger.log(Insert.class.getName(), Level.FINE, "successfull data built", MessageFormat.format("Successfull build of data: {0}.",new Object[]{builtData.getId()}));
                ...
                if(cfgNode.hasAttribute(ParserConst.CFG_AT_DATA_TRIGGER)) {
                    if (null == data.get(cfgNode.getAttribute(ParserConst.CFG_AT_DATA_TRIGGER)).getValue() || 
                        ...
                        xlogger.log(Insert.class.getName(), Level.FINE, "untriggered data", MessageFormat.format("Data found to be untriggered: {0}. It is expected not to be produced in output, nor to be persisted by loaders. It could be employed for cleaning purposes in full updates.",new Object[]{builtData.getId()}));
                    }
                }
                ...
                if(cfgNode.hasAttribute(ParserConst.CFG_AT_DATA_LOAD) && !ParserConst.CFG_RLDRID_VOLATILE.equals(cfgNode.getAttribute(ParserConst.CFG_AT_DATA_LOAD))) {
                    ...
                    if(Const.ERROR == loaders.get(cfgNode.getAttribute(ParserConst.CFG_AT_DATA_LOAD)).getStatus()) {
                        ...
                        xlogger.log(Insert.class.getName(), Level.FINE, "successfull data load", MessageFormat.format("Data loaded successfully: {0}", new Object[]{builtData.getId()}));
                    }
                }
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                xlogger.log(Insert.class.getName(), Level.INFO, "response", responseString);
            }
            catch(Exception e) {
