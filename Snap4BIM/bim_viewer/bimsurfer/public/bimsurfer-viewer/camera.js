...
export class Camera {
    ...
    constructor(viewer) {
        ...
        // used as a listener for cameraPositionUpdate
        this.camPosListeners = [];
    }
    ...
    restore(params) {
        ...
        // the implementation below has some errors
    ...
    // used as listener for the camera parameter changes (20032021)
    updateCameraPos() {
        for (var listener of this.camPosListeners) {
            listener();
        }
    }

    addCamPosListener(fn) {
        this.camPosListeners.push(fn);
    }
}